...
import { AttributesRow } from '../types';

/**
 * Parse CSV file and return array of attributes rows
 * @param filePath Path to the CSV file
 * @returns Array of parsed attributes rows
 */
export function parseAttributesCSV(filePath: string): AttributesRow[] {
  ...
  // Row 2: "Location,Category,Product,Attributes,Location,Category,Product,Attributes"
